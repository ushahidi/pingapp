...
<?php echo Form::open(NULL, array('class' => 'custom')); ?>
	...
	<fieldset>
		...
		<div class="ping-max-number-row">
			<div class="ping-max-number">
	...
	<fieldset>
		...
		<div class="ping-delay-row">
			<div class="ping-delay">
	...
	<div class="update-ping-settings">
		<button class="update-ping-settings-button">Submit</button>
	</div>
<?php echo Form::close(); ?>
